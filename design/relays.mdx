---
title: "Relays"
description: "How iroh relay servers work — purpose, home relay selection, the relay connection handshake, authorization, access control, packet forwarding, and QAD."
---
...
<Note>
For a higher-level introduction to relays, see [Relays](/concepts/relays) in "How it works".
</Note>
...
An endpoint advertises its home relay URL as part of its addressing information (see [Addressing](/design/addressing) and [Address Lookup](/design/address-lookup)), so that remote endpoints know where to find it.
