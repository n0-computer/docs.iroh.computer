...
description: "The pluggable system that resolves an Endpoint ID to dialable transport addresses — DNS, Pkarr, mDNS, and memory lookups, plus publishing and address filtering."
---
...
<Note>
For a higher-level introduction to discovery, see [Discovery](/concepts/discovery) in
"How it works".
</Note>
