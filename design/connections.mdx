---
title: "Connections"
description: "The iroh connection model from the application's perspective — establishing and accepting QUIC connections, streams, datagrams, lifecycle, and path migration."
---
...
These are combined into an **Endpoint Address** (see [Addressing](/design/addressing)).
...
3. The TLS handshake authenticates both peers using their Ed25519 keys (see [Endpoints](/design/endpoints)).
4. The fastest path to complete the handshake is used. If the relay path wins, iroh begins hole punching to establish a direct connection in the background (see [Holepunching](/design/holepunching)).
