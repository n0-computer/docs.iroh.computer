...
description: "Dedicated relay infrastructure managed by the Iroh Online team"
---

By default, iroh endpoints will use Iroh Online hosted relays to facilitate connections when direct
peer-to-peer connections are not possible. These relays are managed and
maintained by the Iroh Online team. For production use cases, you will want to set up
...
If you want to deploy your own hosted relay, you can do that through the Iroh Online
