...
maintained by the Iroh Online team, and are shared by a global public network of
developers.
...
1. **[Public Cloud Relays](/iroh-online/relays/public)**: By default, all iroh nodes will connect to the public cloud relays. These relays have no guaranteed uptime and can be subject to noisy neighbors.
2. **[Dedicated Relays](/iroh-online/relays/managed)**: You can have relays run by the number0 team, by adding them to your project through the Iroh Online platform. This is the easiest way to get started with relays, as Iroh Online will handle the setup and maintenance of the relay servers for you.
