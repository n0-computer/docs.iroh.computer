...
## Part 3: Setup Project Metrics

So far your endpoints are running entirely on their own. [Iroh
Services](https://services.iroh.computer?utm_source=docs&utm_content=quickstart)
gives you a dashboard for metrics, access control, dedicated relays, and remote
diagnostics across all your endpoints.
