...
If you want to see your endpoint's metrics in the [Iroh Services dashboard](https://services.iroh.computer), get an API key from your project's **Settings → API Keys** tab and export it as an environment variable. See [API Keys](/iroh-services/access) for the full walkthrough.

```bash
export IROH_SERVICES_API_SECRET=<your-api-key>
```

The example will pick up the key automatically. Skip this step if you just want to see iroh-ping work.
