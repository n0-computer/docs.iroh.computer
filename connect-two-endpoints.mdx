...
```rust
use anyhow::Result;
use iroh::{protocol::Router, Endpoint, Watcher, endpoint::presets};
use iroh_ping::Ping;
...
<Note>
**Having trouble?** If your ping isn't working or you want to see what's happening under the hood, check out our [troubleshooting guide](/troubleshooting) to enable logging and diagnose issues.
</Note>
...
<Note>
**Connection issues?** If the sender can't reach the receiver or you're seeing errors, visit our [troubleshooting guide](/troubleshooting) to enable detailed logging and use `iroh-doctor` to diagnose network problems.
</Note>

## Part 3: Add observability

So far your endpoints are running entirely on their own. To get a dashboard for
metrics and remote diagnostics across all your endpoints, follow the
[See your direct data rate](/iroh-services/quickstart) tutorial to wire up
your endpoint to [Iroh Services](https://services.iroh.computer?utm_source=docs&utm_content=quickstart).
