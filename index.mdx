...
<Columns cols={2}>
  ...
  <Card
    ...
    href="/compatibility"
  >
    Connect users across platforms and languages, from servers to
    microcontrollers. See [iroh running on
  ...
  <Card
    title="Add a production relay"
    icon="server"
    href="/add-a-relay"
  >
    Choose Shared, Dedicated, or self-hosted relays for production deployments.
  </Card>
