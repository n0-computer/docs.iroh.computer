...
- No [version locking](/iroh-services/relays/managed#version-locking); n0.computer reserves the right to remove support for older iroh versions at any time
- Traffic is rate-limited to prevent abuse

For [version locking](/iroh-services/relays/managed#version-locking), blue/green deployments, or multi-region support, [deploy a managed relay](/iroh-services/relays/managed).
