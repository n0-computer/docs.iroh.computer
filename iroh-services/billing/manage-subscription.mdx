...
Each Dedicated relay is billed monthly per region as an add-on to Pro. Charges
are not calculated from the number of hours the relay was active. Remove relays
