...
Pro and Dedicated relay charges are monthly, not hourly. Removing a relay or
...
and Dedicated relay charges, usage-based overages, and applicable taxes. When
you reach the cap, metrics collection pauses and Shared Relay usage is
constrained to prevent additional connection and egress overages. Dedicated
relays already running are not stopped or throttled and can continue to incur
charges. See [Control your costs](/iroh-services/billing/control-costs) for the
