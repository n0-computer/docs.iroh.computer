...
1. The endpoint is built using the API Key
...
4. Iroh services deletes data on a rolling bases outside the retention window, based on your [plan](https://iroh.computer/pricing). 
...
endpoint and begin sending metrics as long as the API key matches what
has been set up in your project on the Iroh Services platform.
...
[pricing page for more details on plan features and benefits](https://iroh.computer/pricing).
