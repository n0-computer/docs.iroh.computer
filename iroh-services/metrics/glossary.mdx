...
| relay.disco_packets_dropped | Address Lookup packets dropped | Count |
| relay.disco_packets_recv | Address Lookup packets received | Count |
| relay.disco_packets_sent | Address Lookup packets sent | Count |
