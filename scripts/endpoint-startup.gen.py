...
window) and writes ../images/how-iroh-works/endpoint-startup.svg.
...
OUT_PATH = os.path.normpath(os.path.join(
    HERE, "..",
    "images", "how-iroh-works", "endpoint-startup.svg"))
...
# this just clips it. The MDX embeds this as <Frame><img style='width:100%'/>;
