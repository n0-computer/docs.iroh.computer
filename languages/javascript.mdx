...
- **Platforms:** Node.js 20.3+ on macOS (arm64), Linux (x86_64, aarch64 — glibc + musl, armv7), Windows (x86_64, aarch64), Android (aarch64, armv7) ([full matrix](/languages#platform-support))
- **API reference:** [JavaScript API docs](https://n0-computer.github.io/iroh-ffi/js/)
- **Example code:** [iroh-js test scripts](https://github.com/n0-computer/iroh-ffi/tree/main/iroh-js/test) — runnable scripts exercising endpoints, keys, and relays
