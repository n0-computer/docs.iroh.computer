...
Requires Node.js 20.3.0 or newer. Prebuilt binaries are published for:

- macOS: `arm64`
- Linux: `x86_64` and `aarch64` (gnu + musl), `armv7` (gnueabihf + musleabihf), Android (`aarch64`, `armv7`)
