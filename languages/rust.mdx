...
- **Platforms:** iOS, Android, macOS, Linux (glibc + musl), Windows — every officially supported platform ([full matrix](/languages#platform-support))
- **API reference:** [docs.rs/iroh](https://docs.rs/iroh)
- **Example app:** [sendme](https://github.com/n0-computer/sendme) — CLI for direct file transfers between devices
