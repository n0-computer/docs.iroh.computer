...
| [TypeScript](https://github.com/rayhanadev/iroh-ts) | Community-maintained | Third-party package |

All four official bindings share the same basic API surface for sending streams or datagrams over QUIC. 
