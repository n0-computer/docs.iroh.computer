...
<Frame>
  <img src="/images/how-iroh-works/embedding-phone.svg" alt="iroh embedded across six device contexts: iOS, Android, desktop, browser, server, embedded" style={{ background: '#fff', borderRadius: '0.5rem', padding: '0.75rem', width: '100%' }} />
</Frame>
...
<Frame>
  <img src="/images/how-iroh-works/connect-by-key.svg" alt="Alice connects to Bob by key — IPs change, the key stays stable" style={{ background: '#fff', borderRadius: '0.5rem', padding: '0.75rem', width: '100%' }} />
</Frame>
...
<Frame>
  <img src="/images/how-iroh-works/routing-moves.svg" alt="Alice and Bob connected via a shared router, with two more routers available for when Bob moves" style={{ background: '#fff', borderRadius: '0.5rem', padding: '0.75rem', width: '100%' }} />
</Frame>
...
<Frame>
  <img src="/images/how-iroh-works/endpoint-startup.svg" alt="A map of the US and Europe with iroh relays in us-west (Seattle), us-east (Delaware), and eu-west (Frankfurt), and an endpoint in Florida" style={{ background: '#fff', borderRadius: '0.5rem', padding: '0.75rem', width: '100%' }} />
</Frame>
...
<Frame>
  <img src="/images/how-iroh-works/publish-relay.svg" alt="Bob publishes a signed DNS record with his home relay to dns.iroh.link via an HTTPS PUT; Alice resolves it with a DNS lookup" style={{ background: '#fff', borderRadius: '0.5rem', padding: '0.75rem', width: '100%' }} />
</Frame>
...
<Frame>
  <img src="/images/how-iroh-works/publish-relay-dht.svg" alt="Bob publishes his signed record to several random nodes of the Mainline DHT; Alice resolves it by querying several random nodes" style={{ background: '#fff', borderRadius: '0.5rem', padding: '0.75rem', width: '100%' }} />
</Frame>
...
<Frame>
  <img src="/images/how-iroh-works/hole-punching.svg" alt="Alice and Bob, each behind a home router, connected through the relay — all data flows up to the relay and back down" style={{ background: '#fff', borderRadius: '0.5rem', padding: '0.75rem', width: '100%' }} />
</Frame>
...
<Frame>
  <img src="/images/how-iroh-works/hole-punching-lan.svg" alt="Alice and Bob on the same home network discover each other over the relay, then connect directly across the LAN — the relay uplink fades away once the local path is validated" style={{ background: '#fff', borderRadius: '0.5rem', padding: '0.75rem', width: '100%' }} />
</Frame>
