...
<Frame>
  <img src="https://www.iroh.computer/animations/embedding-phone.svg" alt="iroh embedded across six device contexts: iOS, Android, desktop, browser, server, embedded" style={{ width: '100%' }} />
</Frame>
...
<Frame>
  <img src="https://www.iroh.computer/animations/connect-by-key.svg" alt="Alice connects to Bob by key — IPs change, the key stays stable" style={{ width: '100%' }} />
</Frame>
...
<Frame>
  <img src="https://www.iroh.computer/animations/routing-moves.svg" alt="Alice and Bob connected via a shared router, with two more routers available for when Bob moves" style={{ width: '100%' }} />
</Frame>
...
<Frame>
  <img src="https://www.iroh.computer/animations/endpoint-startup.svg" alt="A map of the US and Europe with iroh relays in us-west (Seattle), us-east (Delaware), and eu-west (Frankfurt), and an endpoint in Florida" style={{ width: '100%' }} />
</Frame>
...
<Frame>
  <img src="https://www.iroh.computer/animations/hole-punching.svg" alt="Alice and Bob, each behind a home router, connected through the relay — all data flows up to the relay and back down" style={{ width: '100%' }} />
</Frame>
...
<Frame>
  <img src="https://www.iroh.computer/animations/hole-punching-lan.svg" alt="Alice and Bob on the same home network discover each other over the relay, then connect directly across the LAN — the relay uplink fades away once the local path is validated" style={{ width: '100%' }} />
</Frame>
