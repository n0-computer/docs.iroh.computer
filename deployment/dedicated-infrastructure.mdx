...
To use a relay you self-host with your iroh endpoint, configure it with your relay URLs:

<RelayEndpointConfig />

Managed relays from Iroh Services **require authentication by default**, and your endpoints authenticate to them with your project's API key. For that flow — and full deployment steps — see the [managed relay guide](/iroh-services/relays/managed).
